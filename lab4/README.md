...
3. `mvn clean install` внутри директории lab4/standalone
4. `java -jar lab4-standalone.jar` внутри директории lab4/standalone/target
5. `mvn clean install` внутри директории lab4/client
6. `java -jar lab4-client.jar http://localhost:8080/api/v1/hero` внутри директории lab4/client/target 
...
9. `mvn clean install` внутри директории lab4/j2ee
10. Задеплоить `lab4-j2ee.war` 
11. `mvn clean install` внутри директории lab4/client
12. `java -jar lab4-client.jar http://localhost:8080/lab4-j2ee/api/v1/hero` внутри дирикетории lab4/client/target
