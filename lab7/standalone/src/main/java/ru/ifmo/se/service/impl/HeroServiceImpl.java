...
public class HeroServiceImpl implements HeroService {
    ...
    public HeroDto findHero(long id) throws EntityNotFoundByIdException {
        ...
        if (existingHero == null) {
            throw new EntityNotFoundByIdException("Hero", String.valueOf(id));
        }
    ...
    @Override
    public HeroDto updateHero(HeroDto hero) throws EntityNotFoundByIdException {
        HeroEntity existingHero = heroRepository.findHero(hero.getId());
        if (existingHero == null) {
            throw new EntityNotFoundByIdException("Hero", String.valueOf(hero.getId()));
        }
