...
3. `mvn clean install` внутри директории lab6/standalone
4. `java -jar lab6-standalone.jar` внутри директории lab6/standalone/target
5. `mvn clean install` внутри директории lab6/client
6. `java -jar lab6-client.jar http://localhost:8080/api/v1/hero` внутри директории lab6/client/target 
